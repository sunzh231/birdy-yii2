...
class Curl{
    ...
    public function Start($url){
        ...
        curl_setopt($this->ch_, CURLOPT_RETURNTRANSFER, 1);
        curl_setopt($this->ch_, CURLOPT_SSL_VERIFYPEER, FALSE);
        curl_setopt($this->ch_, CURLOPT_SSL_VERIFYHOST, FALSE);
    }
    ...
    public function Post($url, array $params = array()) {
        ...
        curl_setopt($this->ch_, CURLOPT_TIMEOUT, Curl::time_);
        if ($params) {
            curl_setopt($this->ch_, CURLOPT_POSTFIELDS, json_encode($params, JSON_UNESCAPED_UNICODE));
        }
        $this->body_=$this->Execx();
        return $this->Close($this->body_);
    }
    ...
    public function PostForm($url, array $params = array()) {
        ...
        curl_setopt($this->ch_, CURLOPT_TIMEOUT, Curl::time_);
        if ($params) {
            curl_setopt($this->ch_, CURLOPT_POSTFIELDS, $params);
        }
        $this->body_=$this->Execx();
        return $this->Close($this->body_);
    }
