...
class Jssdk {
  ...
  public static function getJsApiTicket($appId, $appSecret) {
    $access_token = Weconnect::getAccessToken($appId, $appSecret);
    // 如果是企业号用以下 URL 获取 ticket
    // $url = "https://qyapi.weixin.qq.com/cgi-bin/get_jsapi_ticket?access_token=$accessToken";
    $url = "https://api.weixin.qq.com/cgi-bin/ticket/getticket?type=jsapi&access_token=".$access_token->access_token;
    $curl = new Curl;
    $res = $curl->Get($url);
    $ticket = $res->ticket;
