...
class m170603_123921_create_mtl_tags extends Migration
{
  public function up()
  {
    $tableOptions = null;
    ...
    $this->createTable('mtl_tags', [
      'id' => $this->primaryKey()->comment('主键'),
      'name' => $this->string(16)->notNull()->unique()->comment('标签名称'),
      'type' => $this->integer()->notNull()->unique()->comment('类型'),
      'color' => $this->string(16)->comment('标签颜色值'),
